...
import { JssThemeDefault, DeepPartial, JssThemeConstructor } from './typings';
 ...
 */
export const createDefaultJssTheme = (
  themeConfig: DeepPartial<JssThemeDefault> = {}, Theme?: JssThemeConstructor<JssThemeDefault>,
): JssThemeDefault => ({
